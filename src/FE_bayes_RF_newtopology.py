...
def create_model(blocks,
    ...
    for b in range(int(blocks)):
        ...
        t = tf.keras.layers.Activation('relu', name=f'a{b}')(x)
        z = tf.keras.layers.BatchNormalization(name=f'bn{b}')(t)
        ...
        y = tf.keras.layers.Subtract()([x, y])
        x = tf.keras.layers.Add()([z, y])
...
if __name__ == '__main__':
    ...
    pbounds = {'blocks': ('int', [1, 10]), **block_code}
